...
const About = () => {
  return (
    ...
    >
      <h2 className="text-4xl lg:text-5xl font-bold mb-4 inline-block h-[105px] text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-blue-500 to-[#FA1979] dark:from-slate-100 dark:via-[#FA1979] dark:to-blue-500">
