        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-4">
          <div className="col-span-8 md:col-span-4 ">
            <aside className=" bg-white dark:bg-slate-900 p-4 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold mb-4 border-b border-slate-200 dark:border-slate-800">
                Education
              </h2>
          ...
          <section className="col-span-8 bg-white dark:bg-slate-900  p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 border-b border-slate-200 dark:border-slate-800">
              Experience
            </h3>
            {experience.map((pos) => (
