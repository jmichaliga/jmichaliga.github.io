      ...
      <Flex>
        ...
        <Box width={1} p={3}>
          <Center mt={4}>
            ...
            <H3><span role="img" aria-label="marker">🖍</span> Design Tools</H3>
            <Ul>
            ...
            <H3><span role="img" aria-label="mic">🎤</span> Streaming</H3>
            <Ul>
              <Li>Yeti Blue Mic</Li>
              <Li>MBP Webcam</Li>
            </Ul>

            <H3><span role="img" aria-label="computer">💻</span> Hardware</H3>
            <Ul>
              <Li>15" MBP 2018</Li>
              <Li>15" MBP 2012</Li>
